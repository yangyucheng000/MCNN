...
DEFINE_string(dataset_path, "../test_data/preprocess_data", "dataset path");
DEFINE_string(label_path, "../test_data/ground_truth_csv", "label path");
...
int main(int argc, char **argv) {
    ...
    auto all_labels = GetAllFiles(FLAGS_label_path);
    ...
    for (size_t i = 0; i < size; ++i) {
        ...
        std::cout << "      It's label is:      " << all_labels[i] << std::endl;
